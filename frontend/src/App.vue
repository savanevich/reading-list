...
export default {
  ...
  methods: {
    ...
    onSortingEnded(sortedBooks) {
      this.booksByCategories[this.categoryId] = sortedBooks;
    },
    ...
    onRemoveCategory(categoryId) {
      ...
      if (+categoryId === +this.categoryId) {
        [this.categoryId] = Object.keys(this.booksByCategories);
      }
    },
  },
  mounted() {
    [this.categoryId] = Object.keys(this.booksByCategories);
    [this.selectedBook] = this.booksByCategories[this.categoryId];
  ...
  computed: {
    filteredBooks() {
      if (this.categoryId) {
        return this.booksByCategories[this.categoryId];
      }
